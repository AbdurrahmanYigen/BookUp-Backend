...
describe('user', () => {
    ...
    // it('should create a offer for a User via Route' , async(done) => {
    //     await helper.resetDatabase();
    //     await helper.loadFixtures();
    //     request(helper.app)
    //     .post('/1/offer')
    ...
    //     .send({
    //         "title": "Test-offer",
    //         "description": "This is a test description for a test offer",
    //         "duration": 15,
    ...
    //         expect(user.offers.length).toBe(1);
    //         expect(user.offers[0].title).toBe("Test-offer");
    //         expect(user.offers[0].description).toBe("This is a test description for a test offer");
    //         expect(user.offers[0].duration).toBe(15);
    //         expect(user.offers[0].link).toBe("lorem/ipsum/dolor/sit/amet");
    //         done();
    //     })
    // } )
